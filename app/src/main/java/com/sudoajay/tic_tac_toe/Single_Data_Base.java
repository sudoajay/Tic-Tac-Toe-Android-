...
public class Single_Data_Base extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Single_Data_Table.db";
    public static  String DATABASE_TABLE_NAME = "Single_Type_Table";
    public static final String col_1 = "ID";
    public static final String col_2 = "first_Name";
    public static final String col_3 = "second_Name";
    public Single_Data_Base(Context context  )
    {
