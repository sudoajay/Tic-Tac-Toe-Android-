...
public class sound_On_Database extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Sound_Setting.db";
    public static  String DATABASE_TABLE_NAME = "Sound_Setting_Table";
    public static final String col_1 = "ID";
    public static final String col_2 = "Sound";
    public sound_On_Database(Context context  )
    {
    ...
    public void Fill_It(String Sound ){
    ...
    public void Update_The_Table(String id , String Sound ){
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
